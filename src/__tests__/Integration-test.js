...
var initialSpec = {
  points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
  extenders:{p2:{base:'p1',ref:'p0',angle:7.1600000000000055,len:5,speed:0.04}},
  rotaries:{p1:'p2'},
  groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
};
...
var State0_State14_State4_State6_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:1.5000000000000007,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{
      p0:{p1:{len:1}},
      p1:{p0:{len:1},p2:{len:5}},
      p2:{p1:{len:5},p4:{len:17.71089208411792}},
      p3:{p4:{len:15.273833834371775}},
      p4:{p2:{len:17.71089208411792},p3:{len:15.273833834371775}}
    },
    extenders:{p2:{base:'p1',ref:'p0',angle:1.5000000000000007,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'},p3:{x:17.1,y:-1.2,id:'p3'}},
  },
...
var deleteSpec = {
  points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
  extenders:{p2:{base:'p1',ref:'p0',angle:13.900000000000063,len:5,speed:1}},
  rotaries:{p1:'p2'},
  groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
};
...
var State0_State14_State4_State6_State0_State9_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.299999999999982,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5},p4:{len:12.564522752030888},p5:{len:9.936616918299022}},p3:{p4:{len:10.165136496870073}},p4:{p2:{len:12.564522752030888},p3:{len:10.165136496870073},p5:{len:16.32482771731451}},p5:{p4:{len:16.32482771731451},p2:{len:9.936616918299022}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.299999999999982,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'},p3:{x:16.7,y:-0.2,id:'p3'}},
  },
...
var State0_State1_State0_State11_State0_State11_State0_State14_State4_State5_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.99999999999998,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5},p6:{len:13.550305595766215}},p3:{p4:{len:1}},p4:{p3:{len:1},p5:{len:5}},p5:{p4:{len:5},p6:{len:12.16552506059644}},p6:{p2:{len:13.550305595766215},p5:{len:12.16552506059644}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.99999999999998,len:5,speed:1},p5:{base:'p4',ref:'p3',angle:0.9272952180016122,speed:1,len:5}},
    rotaries:{p1:'p2',p4:'p5'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'},p3:{x:13.3,y:-1.2,id:'p3'},p4:{x:12.3,y:-1.2,id:'p4'}},
  },
...
var State0_State14_State4_State6_State0_State7_State0_State3_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:14.150000000000066,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5},p4:{len:13.524215351034957}},p3:{p4:{len:11.237882362794158}},p4:{p2:{len:13.524215351034957},p3:{len:11.237882362794158}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:14.150000000000066,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:0.8,y:2.5,id:'p0'},p1:{x:-0.2,y:2.5,id:'p1'},p3:{x:-17.5,y:3.3,id:'p3'}},
  },
...
var State0_State1_State2_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.84999999999998,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5},p4:{len:18.463637150668838}},p3:{p4:{len:14.023551618616446}},p4:{p2:{len:18.463637150668838},p3:{len:14.023551618616446}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.84999999999998,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'},p3:{x:19.2,y:4.5,id:'p3'}},
  },
...
var State0_State7_State8_State7_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.549999999999981,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    ...
    extenders:{p2:{base:'p1',ref:'p0',angle:7.549999999999981,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:3.5,y:1,id:'p0'},p1:{x:2.5,y:1,id:'p1'}},
  },
...
var State0_State1_State13_State0 = {
  initialSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.249999999999982,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'}},
  },
  finalSpec: {
    points:{p0:{p1:{len:1}},p1:{p0:{len:1},p2:{len:5}},p2:{p1:{len:5},p4:{len:15.020110003172254}},p3:{p4:{len:14.467895493125459}},p4:{p2:{len:15.020110003172254},p3:{len:14.467895493125459}}},
    extenders:{p2:{base:'p1',ref:'p0',angle:7.249999999999982,len:5,speed:1}},
    rotaries:{p1:'p2'},
    groundPoints:{p0:{x:1,y:0,id:'p0'},p1:{x:0,y:0,id:'p1'},p3:{x:11,y:1.3,id:'p3'}},
  },
...
describe('state behaviors and transitions', function() {
  function runTest(desc, initialSpec, eventLog, finalSpec) {
    ...
    findTriangles(initialSpec);
    console.log('');
    findTriangles(finalSpec);
...
function _addSolution(solutionMap, p1ID, p2ID, p3ID, solutionIndex) {
  if (!solutionMap[p1ID]) {
    solutionMap[p1ID] = {};
  }
  if (!solutionMap[p1ID][p2ID]) {
    solutionMap[p1ID][p2ID] = {};
  }
  solutionMap[p1ID][p2ID][p3ID] = solutionIndex;

  if (!solutionMap[p2ID]) {
    solutionMap[p2ID] = {};
  }
  if (!solutionMap[p2ID][p1ID]) {
    solutionMap[p2ID][p1ID] = {};
  }
  solutionMap[p2ID][p1ID][p3ID] = solutionIndex ? 0 : 1;
}

function findTriangles(spec) {
  var solutionMap = {};

  Object.keys(spec.points).forEach(p0id => {
    if (spec.rotaries[p0id]) {
      return;
    }
    Object.keys(spec.points[p0id]).forEach(p1id => {
      Object.keys(spec.points[p1id]).forEach(p2id => {
        if (!spec.rotaries[p2id] && p0id !== p2id) {
          console.log('triangle:', p0id, p2id, p1id);
          if (!solutionMap[p0id]) {
            _addSolution(solutionMap, p0id, p2id, p1id, 0);
          }
        }
      })
    })
